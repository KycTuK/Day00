...
double	sum				= 0;	//	Credit total summ
double	rate			= 0;	//	Annual interest rate
int		term			= 0;	//	Number of loan months
...
// selectedMonth	    = 0;
// payment			    = 0;
PaymentDate = DateTime.Now.AddDays(1 - DateTime.Now.Day).AddMonths(0); // Get current Date with first day of month
